...
This folder contains Python projects completed for my analytics coursework, focusing on data cleaning, exploratory analysis, 
statistical inference, and regression modeling. Each project works with real-world datasets and demonstrates applied skills in 
pandas, NumPy, SciPy, Matplotlib, Seaborn, and Plotly.
